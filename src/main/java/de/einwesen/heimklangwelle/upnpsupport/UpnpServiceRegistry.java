...
public class UpnpServiceRegistry {
    ...
    public void addRendererDevice(AbstractRendererWrapper rendererInstance) throws ValidationException, IOException {
        ...
        this.upnpService.getRegistry().addDevice(new LocalDevice(
                identity,
                type,
                details,
                new Icon[]{icon},
